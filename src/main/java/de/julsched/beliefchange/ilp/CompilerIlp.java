...
public class CompilerIlp extends BeliefChangeCompiler {

    private Encoding encoding;

    public CompilerIlp(File instanceFile, boolean validateInstance, Operation operation, Distance distance, Algorithm preCompilationAlgorithm) {
